...
<div class="content content-nav-base shopcart-content">
    ...
    <div class="cart w1200">
        <div style="height: 500px;border: 1px solid #C9C9C9;text-align: center">
            ...
            <i class="layui-icon layui-icon-ok-circle" style="font-size: 100px; color: #FF5722;"></i>
            <h2>收货确认成功</h2>
            <a href="<c:url value="/index"/>">返回首页</a>
            <a href="<c:url value="/order/order_list"/>">返回</a>
            <%--<a href="<c:url value="/comment/comment_show?comm_id=${comment.comm_id}"/>">查看退单申请</a>--%>
        </div>
    </div>
