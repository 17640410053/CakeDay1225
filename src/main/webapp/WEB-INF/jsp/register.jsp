            ...
            <div class="form-box" style="width: 380px;"><%--改登录框的宽度--%>
                <div class="layui-tab">
                    <ul class="layui-tab-title">
                        <li class="layui-this">用邮箱验证码注册</li>
                        <li>用邮箱密码注册</li>
                        <li>用户名注册</li>
                    </ul>
                    <div class="layui-tab-content">
                            ...
                            <form class="layui-form" action="">
                                ...
                                <div class="layui-form-item login-btn">
                                    <div class="layui-input-block">
                                        <button class="layui-btn" lay-submit lay-filter="register-for-code"
                                                onclick="return false">注册
                                        </button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="layui-tab-item">
                            <form class="layui-form" action="">
                                ...
                                <div class="layui-form-item login-btn">
                                    <div class="layui-input-block">
                                        <button class="layui-btn" lay-submit lay-filter="register-for-pass"
                                                onclick="return false">注册
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="layui-tab-item">
                            <form class="layui-form" action="">
                                ...
                                <div class="layui-form-item login-btn">
                                    <div class="layui-input-block">
                                        <button class="layui-btn" lay-submit lay-filter="register-for-name"
                                                onclick="return false">注册
                                        </button>
                                    </div>
                                </div>
...
<script type="text/javascript">
    layui.config({
        ...
        //监听提交
        form.on('submit(register-for-code)', function (data) {
            $.post('${pageContext.request.contextPath}/register', data.field, function (msg) {
                if (msg.code === 2001) {
                    layer.msg(msg.msg);
                    ...
                    layer.msg(msg.msg, {time: 2000, icon: 2});
                    // layer.msg(msg.msg);
                }
            });
            return false;
        ...
        //监听提交
        form.on('submit(register-for-name)', function (data) {
            $.post('${pageContext.request.contextPath}/register', data.field, function (msg) {
                if (msg.code === 2001) {
                    layer.msg(msg.msg);
                    /**
        ...
        //监听提交
        form.on('submit(register-for-pass)', function (data) {
            $.post('${pageContext.request.contextPath}/register', data.field, function (msg) {
                if (msg.code === 2001) {
                    layer.msg(msg.msg);
                    location.href = "${pageContext.request.contextPath}/user/login";
