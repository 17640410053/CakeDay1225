...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/res/layui/css/layui.css?t=1545041465480"/>" media="all">
    <style>
        body{margin: 10px;}
...
<script src="<c:url value="/res/layui/layui.js?t=1545041465480"/>"></script>
<script>
    layui.config({
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'type_id', title: 'ID', width:80, sort: true, fixed: 'left', totalRowText: '合计：'}
                ,{field: 'name', title: '用户名', width:130}
                ,{field: 'experience', title: '积分', width: 90, sort: true, totalRow: true}
                ,{field: 'sex', title: '性别', width:80, sort: true}
                ,{field: 'score', title: '评分', width: 80, sort: true, totalRow: true}
                ,{field: 'city', title: '城市', width:160}
                ,{field: 'sign', title: '签名', width: 210}
